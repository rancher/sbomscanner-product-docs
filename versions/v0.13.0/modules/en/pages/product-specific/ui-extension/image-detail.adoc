...
CVE ID::
Links to the xref:product-specific/ui-extension/cve-detail.adoc[CVE detail page].
...
Exploitability::
Whether the CVE is suppressed by VEX, for example `Affecting` or `Suppressed`. See xref:product-specific/ui-extension/vex-management.adoc[].
